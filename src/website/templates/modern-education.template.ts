      ...
      sections: [
        {
          ...
          starterContent: {
            ...
            title: lt('Learn Something New at {{academyName}}', 'تعلّم شيئًا جديدًا في {{academyName}}'),
            description: lt(
        ...
        },
        {
          ...
          starterContent: {
            ...
            description: lt('A few of our most popular courses to get you started.', 'بعض من أكثر دوراتنا شهرة لتبدأ رحلتك.'),
          },
        },
        {
          type: 'statistics',
          dynamicDefaults: {
            items: [
              { id: 'stat-courses', metric: 'courses', value: lt('0'), label: lt('Courses', 'دورة') },
              { id: 'stat-students', metric: 'students', value: lt('0'), label: lt('Students', 'طالب') },
              { id: 'stat-instructors', metric: 'instructors', value: lt('0'), label: lt('Instructors', 'مدرّب') },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          starterContent: {
            ...
            description: lt('Create your account and enroll in your first course today.', 'أنشئ حسابك وسجّل في أول دورة لك اليوم.'),
