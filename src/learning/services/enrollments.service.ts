 ...
 *
 * Free-course-only, by explicit master plan instruction (P6 §21: "no
 * payment gate on enrollment yet ... free-course behavior is fully
 * buildable now, paid-course gating lands in P13"). A paid course's
 * enrollment attempt is rejected outright (403) — granting free access to
 * paid content would be a real security/business bug, and no purchase
 * flow exists yet to gate on instead.
 */
